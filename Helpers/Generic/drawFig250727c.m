...
% Version 4 (250727c): No outliers, gray scatters, fit all black dash line

function [UIT]=drawFig250727c(edgesX,X0,Y0,nSD,svPath,thrPct,isEg1K)
...
[slps_bno]=dealBinning(edgesX,x_noOL,y_noOL,n_noOL,thrPct);

[slps_awo,~]=dealAll(x_withOL,y_withOL);
[slps_ano,plt_ano1]=dealAll(x_noOL,y_noOL);
...
plot(plt_ano1(:,1),plt_ano1(:,2),'-k','LineWidth',1.5);
...
%% nested functions:
function [uit1]=dealBinning(edgesX,xAll,yAll,nAll,thrPct)
%2. Binning
