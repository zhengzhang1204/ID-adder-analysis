...
function [k_bin_All,k_all_All,CI95_bin,CI95_all]=drawFigDensRescaleV2met95CI(edgesX,X0,Y0,nSD,svPath,lgdLabel,med,lab,thrPct,Nmax)
%% preparing data:
% Rescaling
xM=mean(X0,'omitnan');
yM=mean(Y0,'omitnan');
