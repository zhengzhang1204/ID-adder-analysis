...
%table data.
    ...
    methods
        function tool = ImageAlign(M,R,pad)
            ...
            tool.tab = uitable('Parent',tool.Dialog,'Data',tool.tabData,'ColumnName',{'Mx','My','FLx','FLy'},'Position',[10 10 220 290],'CellSelectionCallback',@tool.tabSelCB); 
